...
boolean WiFiManager::autoConnect(char const *apName, char const *apPassword) {
  ...
  return startConfigPortalBlocking(apName, apPassword);
}
...
boolean WiFiManager::resetAndCheckConnection() {
...
boolean WiFiManager::startConfigPortalBlocking(char const *apName, char const *apPassword) {
  ...
  while (processConfigPortalEnteredData() != true) {
    yield();
  }

  return resetAndCheckConnection();
}
